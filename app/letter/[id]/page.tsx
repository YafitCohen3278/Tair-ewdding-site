      ...
      <div className="w-full max-w-4xl mx-auto relative z-10">
        ...
        <div className="mt-8">
          {isLocked ? (
            ...
            <LetterContent title={letter.title} sender={letter.sender} contentUrl={letter.content_url} contentUrls={letter.content_urls} contentText={letter.content_text} videoUrl={letter.video_url} />
          )}
        </div>
      </div>
    </main>
